...
|---|---|---|
| Binaries signed and notarised | ✅ Done | Both binaries verified signed/notarised in the actual [v0.1.0 release](https://github.com/y-marui/alfred-note-md-template/releases/tag/v0.1.0) (`codesign -dvvv`, `spctl -a -vvv -t install`, `gh attestation verify`) |
